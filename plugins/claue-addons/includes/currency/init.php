...
class Claue_Addons_Currency {
	...
	**/
	public static function jsa_keep_currency_in_order_page($currency_symbol, $currency ) {
		global $post;
		if ((isset($_REQUEST['post']) && isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' && $post && $post->post_type == 'shop_order') || (isset($_REQUEST['post_type']) && $_REQUEST['post_type'] == 'shop_order') ) {
