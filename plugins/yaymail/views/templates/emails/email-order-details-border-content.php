...
<tfoot class="yaymail_element_foot_order_item">	
	...
	if ( ! empty( $order->get_customer_note() ) ) {
		...
		<tr class="yaymail_item_note_title_row">
			...
			<th class="td" colspan="<?php echo(!empty($productItemCost) ? 2 : '' ) ?>"  style="font-weight: normal;text-align:<?php echo esc_attr( $text_align ); ?>;vertical-align: middle;padding: 12px;font-size: 14px;border-width: 1px;border-style: solid;<?php echo esc_attr( $borderColor ); ?>; <?php echo esc_attr( ( 1 === $i ) ? 'border-top-width: 4px;' : '' ); ?>">
