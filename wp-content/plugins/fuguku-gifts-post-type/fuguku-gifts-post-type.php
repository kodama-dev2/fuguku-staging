 ...
 * v2.4.3 - CURRENT - Added FUGU PRODUCTSHOW-ITEM widget: WooCommerce product integration dengan product search autocomplete, auto-fetch gallery images, name, price, description, navigation controls, layout matching FUGU Images-Item untuk consistency
 */
