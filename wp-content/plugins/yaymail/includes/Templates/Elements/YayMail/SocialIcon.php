		...
		>
			...
			if ( isset( $attrs['iconSocialsArr'] ) ) {
				foreach ( $attrs['iconSocialsArr'] as $key => $el ) {
					...
					?><a class="nta-web-icon-socials-wrap" href="<?php echo esc_attr( $el['pathLink'] ); ?>" target="_blank" style="border: none; text-decoration: none;margin-left:<?php echo esc_attr( $margin_left ); ?>"><img border="0" tabindex="0" src="<?php echo esc_attr( $imgUrl ); ?>" height="<?php echo esc_attr( $attrs['widthSocialIcon'] ); ?>" style="margin-right: 0;"/></a><?php
				}
			}
			?>
		</td>
