 ...
 *
 * Layout baru dengan:
 * - Section 1: 2 kolom (images scrollable full height + product info dengan tabs)
		...
		<div class="<?php echo esc_attr($content_class) ?>">
			<div id="product-<?php the_ID(); ?>" <?php post_class( 'mt__40' ); ?>>
				<div class="jas-row mb__50">
					<!-- KOLOM KIRI: IMAGES SCROLLABLE FULL HEIGHT -->
					<div class="jas-col-md-6 jas-col-sm-6 jas-col-xs-12 pr">
						<div class="product-revamp-images-container">
							<?php
								/**
					...
					<div class="jas-col-md-6 jas-col-sm-6 jas-col-xs-12 pr">
						<div class="summary entry-summary jas-sidebar-sticky ts__05">
							<?php
								...
								// Description, Additional Information, Reviews di kolom kanan
								if ( $position == 2 ) {
