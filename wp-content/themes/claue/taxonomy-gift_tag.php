<?php
/**
 * Template for displaying gift tag archives
 * 
 * @package Claue
 * @version 1.0.0
 */
...
<div class="jas-container">
    <div class="jas-row">
        <div class="jas-col-md-12">
            ...
            <!-- Tag Header -->
            <div class="gift-tag-header">
                <h1 class="tag-title">
                    <?php echo esc_html__('Tag:', 'claue'); ?> <?php single_term_title(); ?>
                </h1>
                <?php 
            ...
            <div class="gifts-grid">
                ...
                <?php else : ?>
                    ...
                    <!-- No Gifts Found with Tag -->
                    <div class="no-gifts-found">
                        <div class="no-gifts-icon">
                            <i class="fa fa-gift"></i>
                        </div>
                        <h3><?php echo esc_html__('No Gifts Found with This Tag', 'claue'); ?></h3>
                        <p><?php echo esc_html__('We couldn\'t find any gifts with this tag.', 'claue'); ?></p>
