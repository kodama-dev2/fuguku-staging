...
add_action('wp_enqueue_scripts', function() {
    if (is_product()) {
        ...
        if ($style === 'revamp') {
            wp_enqueue_style('product-revamp', get_template_directory_uri() . '/assets/css/product-revamp.css', [], '2.3.3');
            wp_enqueue_script('product-revamp-js', get_template_directory_uri() . '/assets/js/product-revamp.js', ['jquery'], '2.3.3', true);
        }
    }
});
